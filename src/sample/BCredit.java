...
public class BCredit extends JFrame implements ActionListener {

        FileReader fRead = new FileReader("Credits.txt");
        ...
        public BCredit(String windowName){
